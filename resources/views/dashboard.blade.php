...
<body>
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <div id="sidenavAccordion" class="sb-sidenav accordion sb-sidenav-dark">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <div>
                            <div class="sb-sidenav-menu-heading"><span>VVMALINE</span></div><a class="nav-link active" href="#">
                                
                            </a><a class="nav-link active" href="about">
                                <div class="sb-nav-link-icon"><i class="fa fa-rotate-left"></i></div><span>Выйти</span>
                            </a>
                        </div>
                        <div>
        ...
        <div id="layoutSidenav_content">
            <main></main><div class="bootstrap_datatables">
    ...
    <div class="col-lg-10 mx-auto">
      <div class="card rounded shadow border-0">
        <div class="card-body p-5 bg-white rounded">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/TbdqG67vuis" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </div>
